...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE tutores SET nome = ?, email = ?, cep = ?, endereco = ?, complemento = ?, bairro = ?, cidade = ?, uf = ?, telefone = ?, dt_nascimento = ? WHERE id = ?";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("ssssssssssi", $nome, $email, $cep, $endereco, $complemento, $bairro, $cidade, $uf, $telefone, $dt_nascimento, $tutor_id);
