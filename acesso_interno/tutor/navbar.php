...
<nav class="transparent-nav">
    <div class="nav-container">
        ...
        <ul class="nav-list">
            ...
            <li><a href="/acesso_interno/tutor/pesquisar.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'pesquisar.php' ? 'active' : ''; ?>">Buscar</a></li>
...
<script type="text/javascript" src="/acesso_interno/tutor/navbar.js"></script>
