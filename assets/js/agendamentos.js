    ...
    button.addEventListener('click', (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch('/includes/agendamentos/aceitar-agendamento.php', {
                    method: 'POST',
...
document.querySelectorAll('.btn-recusar').forEach(button => {
    button.addEventListener('click', (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('/includes/agendamentos/recusar-agendamento.php', {
                    method: 'POST',
                    body: JSON.stringify({ id: agendamentoId }),
                    headers: { 'Content-Type': 'application/json' }
                })
...
document.querySelectorAll('.btn-cancelar').forEach(button => {
    button.addEventListener('click', (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('/includes/agendamentos/cancelar-agendamento.php', {
                    method: 'POST',
                    body: JSON.stringify({ id: agendamentoId }),
                    headers: { 'Content-Type': 'application/json' }
                })
