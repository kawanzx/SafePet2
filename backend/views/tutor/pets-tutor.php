                            ...
                            <header class='pet-header'>
                                <span class="fotoPet">
                                    <?php if (!empty($row['foto'])) { ?>
                                        <img id="preview-<?php echo htmlspecialchars($row['id']); ?>" src="<?php echo '/backend/assets/uploads/fotos-pets/' . ($row['foto']); ?>" alt='Foto do pet' class="fotoPetImg">
                                    <?php } else { ?>
                                        <img id="preview-<?php echo htmlspecialchars($row['id']); ?>" src="/backend/assets/uploads/fotos-pets/default-image.png" alt='Foto padrão para pets' class="fotoPetImg">
                                    <?php } ?>
                                </span>
