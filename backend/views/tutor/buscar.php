...
<body>
                    ...
                    <div class="cuidador">
                        <div class="avatar">
                            <img onclick="location.href='perfil-cuidador.php?id=<?php echo $row['id']; ?>'"
                                src="<?php echo '/backend/assets/uploads/fotos-cuidadores/' . htmlspecialchars($row['foto_perfil'] ?: '../../../img/profile-circle-icon.png'); ?>"
    ...
    <script src="/backend/assets/js/buscar.js"></script>
</body>